...
namespace Nop.Web.Framework.Migrations.UpgradeTo440
{
    ...
    public class SettingMigration : MigrationBase
    {
        ...
        public override void Up()
        {
            ...
            if (!settingService.SettingExistsAsync(orderSettings, settings => settings.OrderDitailsAddTotalsOnCustomerCurrency).Result)
            {
                orderSettings.OrderDitailsAddTotalsOnCustomerCurrency = false;
